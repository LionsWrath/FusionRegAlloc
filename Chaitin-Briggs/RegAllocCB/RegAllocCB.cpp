...
#include "/home/dric0/LLVM/llvm/lib/CodeGen/AllocationOrder.h"
#include "/home/dric0/LLVM/llvm/lib/CodeGen/RegAllocBase.h"
#include "/home/dric0/LLVM/llvm/lib/CodeGen/LiveDebugVariables.h"
#include "/home/dric0/LLVM/llvm/lib/CodeGen/Spiller.h"
//#include "/home/dric0/LLVM/llvm/lib/CodeGen/VirtRegMap.h"
//#include "/home/dric0/LLVM/llvm/lib/CodeGen/LiveRegMatrix.h"
...
//  unsigned LiveReg::PhyRegsNum = 1000;
  ...
  public:
    ...
    bool operator==(const LiveRegRange &b) const {
      return reg == b.reg && range == (b.range);		//Removed the * from "*range == *(b.range);" -- verify
    }
...
//      }
      if (LI.liveAt(LiveOutIdx)) {
        ...
        LiveRegs.insert(LiveRegRange(Reg, (LiveRange*)LR));
      }
    }
    ...
    for (MachineBasicBlock::reverse_iterator MIi = MBBi->rbegin(), MIe = MBBi->rend();
      ...
      for (unsigned i = 0; i != MIi->getNumOperands(); ++i) {
        ...
        if (op.isDef()) {
          ...
          LiveRegRange def_reg(reg, (LiveRange*)LR);
        ...
        if (op.isUse()) {
          ...
          LiveRegRange use_reg(reg, (LiveRange*)LR);
